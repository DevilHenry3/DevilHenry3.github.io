		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>MONK CHECKER </strong></h4>
...
<footer>
  <p>Modified By <a href="https://t.me/monkvouches">@Naruto_007123</a></p>
</footer>
<script>
...
swalWithBootstrapButtons.fire({
  title: "Sir MonK", 
  text: "Want to thank MonK",
  icon: 'warning',
  showCancelButton: true,
  confirmButtonText: 'Later',
  cancelButtonText: 'Already thanked',
  reverseButtons: false
}).then((result) => {
  if (result.isConfirmed) {
    Swal.fire({
      title:'Redirecting.',
      text:'You are now being redirected towards MonK profile',
      timer: 1500,
...
function RedirectUrl(){    
       window.location.href ="https://t.me/monkvouches";
    }
